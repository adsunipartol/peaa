...
public class CustomExceptionHandler extends ExceptionHandlerWrapper {
    ...
    public void handle() throws FacesException {
        ...
        while (iterator.hasNext()) {
            ...
            // Aqui tentamos tratar a exceção
            try {
...
//              Por fim você pode converter a pilha de exceções em uma String
                ...
                FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Ocorreu um erro e o processo nao foi concluido. Você pode continuar usando o sistema normalmente!", ""));
                ...
                if ((Usuario) sessao.getAttribute("user") == null)
                    paginaRetorno = "/faces/login.xhtml";
                else
                    paginaRetorno = "/faces/index.xhtml";
                navigationHandler.handleNavigation(facesContext, null, paginaRetorno);
