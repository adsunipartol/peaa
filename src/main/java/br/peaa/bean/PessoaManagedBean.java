...
public class PessoaManagedBean implements Serializable {
    ...
    public void remover(Pessoa pessoa) {
        try {
            srvPessoas.remover(pessoa.getCodigo());
    ...
    public List<Pessoa> getPessoas() {
        if ((this.pessoas == null || this.pessoas.isEmpty()) && srvPessoas != null) {
            this.pessoas = srvPessoas.buscarTodos();
        }
